 ...
 * @author admin
 */
public class ApplicationLogRecorderContextFactory implements LogRecorderContextFactory {

  /**
   * 上下文对象，用来初始化，并提供业务方法.
   */
  private final ApplicationLogRecorderContext context = new ApplicationLogRecorderContext();
   ...
   * @author admin
   */
  public ApplicationLogRecorderContextFactory() {

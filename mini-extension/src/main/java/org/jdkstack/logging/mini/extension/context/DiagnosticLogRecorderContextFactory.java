...
import org.jdkstack.logging.mini.extension.recorder.DiagnosticLogRecorder;
 ...
 * @author admin
 */
public class DiagnosticLogRecorderContextFactory implements LogRecorderContextFactory {

  /**
   * 上下文对象，用来初始化，并提供业务方法.
   */
  private final DiagnosticLogRecorderContext context = new DiagnosticLogRecorderContext();
   ...
   * @author admin
   */
  public DiagnosticLogRecorderContextFactory() {
  ...
  public final void addRecorder(final RecorderConfig recorderConfig) {
    final Recorder logRecorder = new DiagnosticLogRecorder(this.context, recorderConfig);

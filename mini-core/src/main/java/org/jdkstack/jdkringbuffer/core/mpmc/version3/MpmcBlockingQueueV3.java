package org.jdkstack.jdkringbuffer.core.mpmc.version3;
...
public class MpmcBlockingQueueV3<E> extends AbstractLockBlockingQueueV3<E> {
  ...
  public MpmcBlockingQueueV3(final EventFactory eventFactory) {
    super(eventFactory);
  }

  public MpmcBlockingQueueV3(final int capacity, final EventFactory eventFactory) {

 ...
 * @author admin
 */
public class SystemLogRecorderContextFactory implements LogRecorderContextFactory {

  /**
   * 上下文对象，用来初始化，并提供业务方法.
   */
  private final SystemLogRecorderContext context = new SystemLogRecorderContext();
   ...
   * @author admin
   */
  public SystemLogRecorderContextFactory() {
